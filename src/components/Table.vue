...
<template>
    <table class="table">
        <thead class="table__head">
            ...
            <th scope="col" v-for="month in months" :key="getMonthName(month)" :class="{ 'table__head__cell': true, 'table__head__cell--highlight': month === currentMonth }">{{getMonthName(month)}}</th>
        </thead>
